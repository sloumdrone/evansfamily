    ...
    <header class="shell mainheader">
        <nav class="container">
            <ul class="menu row">
                ...
                <li class="col-md-2 col-12 text-center order-3 order-md-2"><a href="<?= get_site_url( null, '/blog' ); ?>" class="navlink">BLOG</a></li>
                ...
                <li class="col-md-2 col-12 text-center text-md-left order-4"><a href="<?= get_site_url( null, '/gallery' ); ?>" class="navlink">GALLERY</a></li>
